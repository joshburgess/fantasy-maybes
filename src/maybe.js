...
Maybe.prototype.orElse = function(x) {
  return this.fold(Maybe.Just, constant(x))
}
Maybe.prototype.getOrElse = function(x) {
  return this.fold(identity, constant(x))
}
Maybe.prototype[chain] = function(f) {
  return this.fold(a => f(a), constant(Maybe.Nothing))
}
...
Maybe.MaybeT = M => {
  ...
  MaybeT.prototype[chain] = function(f) {
    return MaybeT(
      this.run[chain](o => {
        return o.fold(a => f(a).run, () => M[of](Maybe.Nothing))
      })
    )
  }
